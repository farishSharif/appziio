...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @appziio/sdk

# or
yarn add @appziio/sdk
pnpm add @appziio/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Appziio } from '@appziio/sdk'

const appziio = new Appziio({
  apiKey: process.env.APPZIIO_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await appziio.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
